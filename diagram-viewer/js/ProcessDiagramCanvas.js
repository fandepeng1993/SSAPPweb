...
// TODO: generate polylineId or do something!!
		...
		*/
		...
		polyClone.click(function(){
			var instance = this;//getConditionExpression
			var objectId = instance.data("objectId");
			var object = this.paper.getById(objectId);
			var contextObject = object.data("contextObject");
			if (contextObject) {
				//console.log(instance);
				/*console.log(contextObject.id);
				console.log(contextObject.flow);
				console.log(contextObject.sourceActivityId)*/
				/*$.ajax({
					url : "../ProcessDefinitionlController/getNodeType/" + contextObject.sourceActivityId+"," +ProcessDefinitionId,
					datatype : "json",
					type : "get",
					data : {},
					success : function(data, status, xhr) {
						if(data.msg=="exclusiveGateway"){
							admin_role_add('<strong>流条件修改</strong>', "../manage/processMgr/setApproveNode.html?activiyId=" +contextObject.sourceActivityId+"&processDefinitionId=" +ProcessDefinitionId+"&flowId="+contextObject.id, 800);
						}
					}
				});*/
